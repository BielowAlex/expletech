      ...
      <div className="container header-container">
        <Link to="/" className="logo">
          ...
          >
            ...
            />
            <path
              d="M0 517.9C22.3 534.3 46.9 542 74.4 541.6C102.2 541.2 125.6 530.7 148.1 515.1C176 495.8 203.4 474.4 234.2 461C296.5 433.9 357.4 444.2 414.3 480.2C426.1 487.7 437.2 496.3 448.4 504.7C462.2 514.9 475.9 515.7 486.7 506.5C496.8 497.9 498.8 484.3 491 469.5C443.4 379.1 396.5 288.4 347.2 198.9C335.7 177.9 335.8 162.4 351.7 145C353.4 147.2 355.6 149.3 357 151.9C410.1 252.5 463.4 353.1 515.9 454.1C522.1 466.1 527.1 480.7 526.6 493.8C525 533.9 483.2 556.6 445.2 538.8C434 533.5 423.9 525.4 413.9 517.8C340.3 462 263.1 463.2 191.1 521.3C180.2 530.1 169.6 539.3 158.3 547.5C127.7 569.4 93.8 579.1 56.5 571.3C27.4 565.2 8.8 546.7 0 517.9Z"
              fill="white"
            />
            <path
              d="M399.3 411.2C301.3 374.1 216.8 393.9 139 453.2C128.2 461.4 117.6 469.9 106.4 477.4C85.5999 491.2 57.3999 491 39.0999 477.5C21.6999 464.7 13.5999 439.8 20.0999 415.7C22.9999 405 27.1999 394.4 32.3999 384.6C86.5999 281.8 140.4 178.8 196 76.8C207.8 55.1 225.8 36.6 242.3 17.8C248.4 10.9 258.4 7.40002 269.1 0.900024C252.3 31.8 236.7 59.6 221.9 87.8C166.2 194 110.7 300.3 55.3999 406.7C51.5999 413.9 46.8999 423.2 48.4999 430.1C50.4999 438.5 57.2999 447.5 64.5999 452.4C74.2999 459 85.0999 454.7 94.1999 447.4C129.7 419 166.8 393.3 209.7 377.1C258.3 358.8 307.8 356.3 358.4 366.3C372.2 369 382.6 374.5 387.5 388.6C389.9 395.4 394.1 401.6 399.1 411.1L399.3 411.2Z"
              fill="white"
            />
          </svg>
          <span className="logo-text">InPost</span>
        </Link>
        <button className="upload-btn" type="button" onClick={() => dispatch(postsActions.formToggle(true))}>
          <span className="upload-btn__text">Add Post</span>
          <svg className="upload-btn__img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            <path
